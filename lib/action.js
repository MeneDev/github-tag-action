...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const currentBranch = utils_1.getBranchFromRef(ref);
        ...
        const isPreReleaseBranch = preReleaseBranches
            .split(',')
            .some((branch) => currentBranch.match(branch));
        const isPullRequest = utils_1.isPr(ref);
        ...
        let newVersion;
        if (customTag) {
            commits = yield utils_1.getCommits(latestTag.commit.sha, sha);
            ...
            commits = yield utils_1.getCommits(previousTag.commit.sha, sha);
        ...
        yield github_1.createTag(newTag, createAnnotatedTag, sha);
    });
}
